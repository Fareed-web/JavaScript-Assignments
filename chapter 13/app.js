...
function createElement(title, price, category, image, desc) {
    return `
        <div class="p-4 md:w-1/3">
            <div class="h-full border-2 border-gray-200 border-opacity-60 rounded-lg overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <h1 class="title-font text-lg font-medium text-gray-900 mb-3">${title} $${price}</h1>
...
function filterProducts() {
    ...
    const priceRange = document.getElementById('range').value;

    const filteredProducts = products.filter(product => {
        const matchesSearch = product.title.toLowerCase().includes(searchQuery);
        const withinPriceRange = product.price <= priceRange;
